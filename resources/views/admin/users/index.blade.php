...
@section('content')
        ...
        <tbody>
            @foreach ($all_users as $user)
                <tr>
                    ...
                    <td>
                        @if ($user->trashed())
                            {{-- trashed() - returns TRUE if the user is soft deleted --}}
    ...
    <div class="d-flex justify-content-center">
        {{ $all_users->links() }}
        {{-- links method will render the links to the rest of the pages in the result set. Each of these links will already contain proper page query string variable --}}
    </div>
@endsection
